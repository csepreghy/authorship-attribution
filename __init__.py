...
char_f_tr1 = extract_features(train1_df, chars=True)
word_f_tr1 = extract_features(train1_df, words=True)

df = word_f_tr1.rename(columns={"text": "p_truth_E", "author": "Truth"})
